...
trait BlockCypherTransaction {
  ...
  def total : CurrencyUnit
  def fees : CurrencyUnit
  def size : Long
...
case class BlockCypherTransactionImpl(override val blockHash : Option[String], override val blockHeight : Option[Long],
  override val hash : String, override val addresses : Seq[BitcoinAddress], override val total : CurrencyUnit,
  override val fees : CurrencyUnit, override val size : Long, override val preference : String,
